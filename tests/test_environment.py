...
class TestAcornMosOsCallHooks:
    ...
    def test_osbyte_hook_installs_constant_and_expression(self, tmp_path):
        ...
        assert canonical_text(ir.expressions.get_or_none(0x1001)) == "osbyte_clear_escape"
    ...
    def test_osword_hook_installs_constant_and_expression(self, tmp_path):
        ...
        assert canonical_text(ir.expressions.get_or_none(0x1001)) == "osword_read_io_memory"
    ...
    def test_osword_hook_recognises_xy_param_block_address(self, tmp_path):
        ...
        assert canonical_text(ir.expressions.get_or_none(0x1003)) == "<(myblock)"
        # The LDY's operand at &1005 carries ``>(myblock)``.
        assert canonical_text(ir.expressions.get_or_none(0x1005)) == ">(myblock)"
