...
; Move 4: &9565 to &0600 for length 256
    org &0600
; &0600 used as index base 1 time by &8161
.tube_page6_start
...
; | 3-0 | 0010  | Processor: 6502 (non-BASIC) |
    equb %10000010                                                    ; 8006: 82          .        ; ROM type  ROM type: service + language
; &8007 referenced 1 time by &9447
.copyright_offset
    equb copyright - language_entry                                   ; 8007: 0c          .        ; Offset of NUL preceding copyright (= &0c → copyright at &800c)  Copyright string offset from &8000
; &8008 used as index base 2 times by &835c, &8365
.binary_version
    equb &03                                                          ; 8008: 03          .        ; Binary version: &03 (informational, not used by MOS)  Binary version number
.title
    equs "NET"                                                        ; 8009: 4e 45 54    NET      ; ROM title string "NET"
.copyright
    equb &00                                                          ; 800c: 00          .        ; NUL preceding copyright string  Null terminator before copyright
