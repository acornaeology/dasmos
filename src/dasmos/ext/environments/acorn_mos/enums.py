...
OSBYTE_ENUM: dict[int, str] = {
    ...
    0x6B: "osbyte_select_bus",
    0x6C: "osbyte_select_direct_screen_mem",
    0x6d: "osbyte_make_fs_permanent",
    0x70: "osbyte_select_vdu_mem",
    0x71: "osbyte_select_display_mem",
    ...
    0x76: "osbyte_reflect_kbd_status_in_leds",
    ...
    0xb0: "osbyte_cfs_timeout",
    0xb1: "osbyte_input_source",
    0xb2: "osbyte_kbd_semaphore",
    0xb3: "osbyte_primary_oshwm",
    0xb4: "osbyte_current_oshwm",
    0xb5: "osbyte_serial_mode",
    0xb6: "osbyte_read_char_explode_state",
    0xb7: "osbyte_cfs_rfs_switch",
    0xb8: "osbyte_read_video_ula_control",
    0xb9: "osbyte_read_video_ula_palette",
    0xba: "osbyte_rom_bank_at_last_brk",
    0xbb: "osbyte_basic_rom_bank",
    0xbc: "osbyte_read_current_adc_channel",
    0xbd: "osbyte_max_adc_channel",
    0xbe: "osbyte_adc_conversion_type",
    0xbf: "osbyte_serial_user_flag",
    0xc0: "osbyte_read_serial_control_register_copy",
    0xc1: "osbyte_flash_counter",
    0xc2: "osbyte_mark_count",
    0xc3: "osbyte_space_count",
    0xc4: "osbyte_kbd_repeat_delay",
    0xc5: "osbyte_kbd_repeat_rate",
    0xc6: "osbyte_exec_file_handle",
    0xc7: "osbyte_spool_file_handle",
    0xc8: "osbyte_escape_break_effect",
    0xc9: "osbyte_econet_kbd_disable",
    0xca: "osbyte_kbd_status",
    0xcb: "osbyte_serial_handshake_extent",
    0xcc: "osbyte_serial_input_suppression",
    0xcd: "osbyte_cassette_serial_selection",
    0xce: "osbyte_econet_oscall_intercept",
    0xcf: "osbyte_econet_osrdch_intercept",
    0xd0: "osbyte_econet_oswrch_intercept",
    0xd1: "osbyte_speech_suppression",
    0xd2: "osbyte_sound_suppression",
    0xd3: "osbyte_bell_channel",
    0xd4: "osbyte_bell_envelope",
    0xd5: "osbyte_bell_frequency",
    0xd6: "osbyte_bell_duration",
    0xd7: "osbyte_startup_boot_options",
    0xd8: "osbyte_soft_key_length",
    0xd9: "osbyte_lines_since_last_page",
    0xda: "osbyte_vdu_queue_size",
    0xdb: "osbyte_tab_char",
    0xdc: "osbyte_escape_char",
    0xdd: "osbyte_chars_c0_cf_status",
    0xde: "osbyte_chars_d0_df_status",
    0xdf: "osbyte_chars_e0_ef_status",
    0xe0: "osbyte_chars_f0_ff_status",
    0xe1: "osbyte_fkey_status",
    0xe2: "osbyte_shift_fkey_status",
    0xe3: "osbyte_ctrl_fkey_status",
    0xe4: "osbyte_ctrl_shift_fkey_status",
    0xe5: "osbyte_escape_status",
    0xe6: "osbyte_escape_effects",
    0xe7: "osbyte_user_via_irq_mask",
    0xe8: "osbyte_6850_irq_mark",
    0xe9: "osbyte_system_via_irq_mask",
    0xea: "osbyte_read_tube_presence",
    0xeb: "osbyte_read_speech_presence",
    0xec: "osbyte_char_destination_status",
    0xed: "osbyte_cursor_editing_status",
    0xee: "osbyte_27e",
    0xef: "osbyte_27f",
    0xf0: "osbyte_280",
    0xf1: "osbyte_281",
    0xf2: "osbyte_read_serial_ula",
    0xf3: "osbyte_timer_switch_state",
    0xf4: "osbyte_soft_key_consistency_flag",
    0xf5: "osbyte_printer_destination",
    0xf6: "osbyte_printer_ignore_char",
    0xf7: "osbyte_break_intercept_byte_1",
    0xf8: "osbyte_break_intercept_byte_2",
    0xf9: "osbyte_break_intercept_byte_3",
    0xfa: "osbyte_28a",
    0xfb: "osbyte_28b",
    0xfc: "osbyte_current_language_rom_bank",
    0xfd: "osbyte_last_break_type",
    0xfe: "osbyte_available_ram",
    0xff: "osbyte_startup_options",
}


# Deprecated long-form OSBYTE names → their replacement short names.
# Long-name OSBYTEs were shortened in dasmos 1.7.0 (issue #23). Drivers
# that hand-code the old names via ``d.constant(value, "old_name")`` get
# a ``DeprecationWarning`` from the Disassembler, citing the new name,
# but the rendered output keeps working — the deprecated alias is
# slated for removal in the next minor cycle.
#
# Three principles drove the shortening (see the issue for the full
# rationale):
#  1. Drop the ``read_write_`` prefix on OSBYTEs in the read-or-write
#     family — the action comes from the X register at call time, not
#     from the constant name.
#  2. Use standard Acorn-domain abbreviations: ``kbd``, ``fs``, ``mem``,
#     ``fkey``, ``chars``.
#  3. Drop verbose qualifiers like ``main_or_shadow_memory_for_`` and
#     ``temporary`` where they don't disambiguate the OSBYTE itself.
OSBYTE_DEPRECATED_NAMES: dict[str, str] = {
    # Group A — issue #23 worst-offenders table
    "osbyte_select_screen_memory_for_direct_access": "osbyte_select_direct_screen_mem",
    "osbyte_make_temporary_filing_system_permanent": "osbyte_make_fs_permanent",
    "osbyte_select_main_or_shadow_memory_for_vdu_access": "osbyte_select_vdu_mem",
    "osbyte_select_main_or_shadow_memory_for_display": "osbyte_select_display_mem",
    "osbyte_read_write_econet_keyboard_disable": "osbyte_econet_kbd_disable",
    "osbyte_read_write_serial_input_suppression": "osbyte_serial_input_suppression",
    "osbyte_read_write_econet_os_call_interception": "osbyte_econet_oscall_intercept",
    "osbyte_read_write_ctrl_shift_function_key_status": "osbyte_ctrl_shift_fkey_status",
    "osbyte_read_write_second_byte_break_intercept": "osbyte_break_intercept_byte_2",
    # Group B — judgement-call shortenings beyond just dropping read_write_
    "osbyte_selects_internal_or_external_bus": "osbyte_select_bus",
    "osbyte_reflect_keyboard_status_in_leds": "osbyte_reflect_kbd_status_in_leds",
    "osbyte_read_write_cassette_serial_selection": "osbyte_cassette_serial_selection",
    "osbyte_read_write_econet_osrdch_interception": "osbyte_econet_osrdch_intercept",
    "osbyte_read_write_econet_oswrch_interception": "osbyte_econet_oswrch_intercept",
    "osbyte_read_write_function_key_status": "osbyte_fkey_status",
    "osbyte_read_write_shift_function_key_status": "osbyte_shift_fkey_status",
    "osbyte_read_write_ctrl_function_key_status": "osbyte_ctrl_fkey_status",
    "osbyte_read_speech_processor_presence": "osbyte_read_speech_presence",
    "osbyte_read_write_first_byte_break_intercept": "osbyte_break_intercept_byte_1",
    "osbyte_read_write_third_byte_break_intercept": "osbyte_break_intercept_byte_3",
    "osbyte_read_write_keyboard_status": "osbyte_kbd_status",
    "osbyte_read_write_keyboard_semaphore": "osbyte_kbd_semaphore",
    "osbyte_read_write_keyboard_repeat_delay": "osbyte_kbd_repeat_delay",
    "osbyte_read_write_keyboard_repeat_rate": "osbyte_kbd_repeat_rate",
    "osbyte_read_write_characters_c0_cf_status": "osbyte_chars_c0_cf_status",
    "osbyte_read_write_characters_d0_df_status": "osbyte_chars_d0_df_status",
    "osbyte_read_write_characters_e0_ef_status": "osbyte_chars_e0_ef_status",
    "osbyte_read_write_characters_f0_ff_status": "osbyte_chars_f0_ff_status",
    # Group C — mechanical read_write_ drop only
    "osbyte_read_write_6850_control": "osbyte_6850_control",
    "osbyte_read_write_cfs_timeout": "osbyte_cfs_timeout",
    "osbyte_read_write_input_source": "osbyte_input_source",
    "osbyte_read_write_primary_oshwm": "osbyte_primary_oshwm",
    "osbyte_read_write_current_oshwm": "osbyte_current_oshwm",
    "osbyte_read_write_serial_mode": "osbyte_serial_mode",
    "osbyte_read_write_cfs_rfs_switch": "osbyte_cfs_rfs_switch",
    "osbyte_read_write_rom_bank_at_last_brk": "osbyte_rom_bank_at_last_brk",
    "osbyte_read_write_basic_rom_bank": "osbyte_basic_rom_bank",
    "osbyte_read_write_max_adc_channel": "osbyte_max_adc_channel",
    "osbyte_read_write_adc_conversion_type": "osbyte_adc_conversion_type",
    "osbyte_read_write_serial_user_flag": "osbyte_serial_user_flag",
    "osbyte_read_write_flash_counter": "osbyte_flash_counter",
    "osbyte_read_write_mark_count": "osbyte_mark_count",
    "osbyte_read_write_space_count": "osbyte_space_count",
    "osbyte_read_write_exec_file_handle": "osbyte_exec_file_handle",
    "osbyte_read_write_spool_file_handle": "osbyte_spool_file_handle",
    "osbyte_read_write_escape_break_effect": "osbyte_escape_break_effect",
    "osbyte_read_write_serial_handshake_extent": "osbyte_serial_handshake_extent",
    "osbyte_read_write_speech_suppression": "osbyte_speech_suppression",
    "osbyte_read_write_sound_suppression": "osbyte_sound_suppression",
    "osbyte_read_write_bell_channel": "osbyte_bell_channel",
    "osbyte_read_write_bell_envelope": "osbyte_bell_envelope",
    "osbyte_read_write_bell_frequency": "osbyte_bell_frequency",
    "osbyte_read_write_bell_duration": "osbyte_bell_duration",
    "osbyte_read_write_startup_boot_options": "osbyte_startup_boot_options",
    "osbyte_read_write_soft_key_length": "osbyte_soft_key_length",
    "osbyte_read_write_lines_since_last_page": "osbyte_lines_since_last_page",
    "osbyte_read_write_vdu_queue_size": "osbyte_vdu_queue_size",
    "osbyte_read_write_tab_char": "osbyte_tab_char",
    "osbyte_read_write_escape_char": "osbyte_escape_char",
    "osbyte_read_write_escape_status": "osbyte_escape_status",
    "osbyte_read_write_escape_effects": "osbyte_escape_effects",
    "osbyte_read_write_user_via_irq_mask": "osbyte_user_via_irq_mask",
    "osbyte_read_write_6850_irq_mark": "osbyte_6850_irq_mark",
    "osbyte_read_write_system_via_irq_mask": "osbyte_system_via_irq_mask",
    "osbyte_read_write_char_destination_status": "osbyte_char_destination_status",
    "osbyte_read_write_cursor_editing_status": "osbyte_cursor_editing_status",
    "osbyte_read_write_27e": "osbyte_27e",
    "osbyte_read_write_27f": "osbyte_27f",
    "osbyte_read_write_280": "osbyte_280",
    "osbyte_read_write_281": "osbyte_281",
    "osbyte_read_write_timer_switch_state": "osbyte_timer_switch_state",
    "osbyte_read_write_soft_key_consistency_flag": "osbyte_soft_key_consistency_flag",
    "osbyte_read_write_printer_destination": "osbyte_printer_destination",
    "osbyte_read_write_printer_ignore_char": "osbyte_printer_ignore_char",
    "osbyte_read_write_28a": "osbyte_28a",
    "osbyte_read_write_28b": "osbyte_28b",
    "osbyte_read_write_current_language_rom_bank": "osbyte_current_language_rom_bank",
    "osbyte_read_write_last_break_type": "osbyte_last_break_type",
    "osbyte_read_write_available_ram": "osbyte_available_ram",
    "osbyte_read_write_startup_options": "osbyte_startup_options",
}
